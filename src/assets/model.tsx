...
export default function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/3Dmodel/model.gltf') as GLTFResult
  const { actions } = useAnimations(animations, group)
  const { Colour } = useCustomization();

  useEffect(() => {
    // Optional: check which clips are available
    // console.log('Available actions:', Object.keys(actions))

    // If there's a clip named "Animation", play it:
  ...
  return (
    <group ref={group} {...props} dispose={null}>
        ...
        <group name="Scene_Collection">
          <group name="MainScene">
            <group name="basic" />
            <group name="RM_pose_en_applique_enroulement_interieur">
              <group name="RMAEILamesmicroperforees" />
              <group name="RMAEIGrilleCobraRenforcees" />
              <group name="lamesRMAEI" />
            </group>
            <group name="RM_pose_en_applique_enroulement_exterieur">
              <group name="lamesRMAEE" />
              <group name="RMAEEGrilleCobraSimple" />
              <group name="RMAEELamesmicroperforees" />
            </group>
            <group name="RM_pose_sous_linteau_enroulement_interieur">
              <group name="RMLEILamesPleines" />
              <group name="RMLEIGrilleCobraSimple" />
              <group name="RMLEIGrilleBijoutier" />
            </group>
            <group name="RM_sous_linteau_enroulement_exterieur">
              <group name="RMLEELamesmicroperforees" />
              <group name="RMLEEGrilleCobraRenforcees" />
              <group name="lamesRMLEE" />
            </group>
          </group>
            ...
            <group name="RMBaked">
              ...
              <group name="RMAEILamesPleinesBaked">
                ...
                <group name="CoffreAndCoulisseBaked">
                  <mesh name="CoffreFrontRMAEI_Baked" castShadow receiveShadow geometry={nodes.CoffreFrontRMAEI_Baked.geometry} material={materials.RimsR} position={[-0.09, 0.039, -0.005]} material-color={Colour.name} rotation={[Math.PI, 0, Math.PI]} />
                </group>
              </group>
